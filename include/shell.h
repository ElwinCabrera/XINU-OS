...
#define SHELL_PROMPT    "\033[0;32mxsh$ \033[0;39m"              /**< prompt                 */
...
command xsh_parrot(        ushort, ushort, ushort, ushort, char *[]);
command xsh_palindrome(    ushort, ushort, ushort, ushort, char *[]);
command xsh_palan(         ushort, ushort, ushort, ushort, char *[]);
command xsh_schedule(      ushort, ushort, ushort, ushort, char *[]);
command xsh_sem(     ushort, ushort, ushort, ushort, char *[]);
command xsh_yap(     ushort, ushort, ushort, ushort, char *[]);
